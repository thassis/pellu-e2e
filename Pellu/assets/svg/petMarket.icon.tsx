...
type PetMarketSvgProps = {
  size?: number;
  color?: string;
};

const PetMarketSvg = ({size = 24, color = 'black'}: PetMarketSvgProps) => {
  return (
    <Svg
      fill={color}
      width={size}
      ...
      <Path
        d="M126.544,211.321c2.151,3.716,0.978,8.605-2.738,10.854c-3.814,2.249-8.605,0.978-10.854-2.738l-14.277-24.055v20.242
